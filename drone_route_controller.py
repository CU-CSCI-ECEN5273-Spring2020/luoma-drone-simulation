...
class l3_switch (EventMixin):
  def __init__ (self, fakeways = [], arp_for_unknowns = False):
    ...
    # For each switch, we map the IP address and MAC address of the
    # attached host. Used for routing.
    self.host_switch_table = {}
  ...
  def _handle_PacketIn (self, event):
    ...
    if isinstance(packet.next, ipv4):
      ...
      if dstaddr == "192.168.1.253":
        ...
        self.host_switch_table[dpid] = (packet.next.srcip, packet.src)
